<template>
    ...
    <AuthenticatedLayout>
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Editar Aula</span>
                </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="border-b border-gray-200 pb-5 sm:flex sm:items-center sm:justify-between">
            ...
            <h3 class="text-lg leading-6 text-gray-900">Edição de Aula</h3>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 border-b border-gray-200">
                <form @submit.prevent="$event => form.put(route('admin.lessons.update', [props.module.id, props.lesson.id]))">
...
const form = useForm({
    ...
    embed: props.lesson.embed,
    plataform: props.lesson.plataform,
