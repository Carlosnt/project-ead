<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="border-b border-gray-200 pb-5 sm:flex sm:items-center sm:justify-between">
            ...
            <h3 class="text-lg leading-6 text-gray-900">Cadastro de Módulo para p curso <b class="text-bold">{{  course.name }}</b></h3>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 border-b border-gray-200">
                <form @submit.prevent="$event => form.post(route('admin.modules.store'))">
                    
                    <div class="border-b border-gray-900/10 pb-12">
                        <h2 class="text-base font-semibold leading-7 text-gray-900">Informações de módulo</h2>
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-2">
                                <label for="category_id" class="block text-sm font-medium leading-6 text-gray-900">Courso</label>
                                <div class="mt-2">
