    ...
    <AuthenticatedLayout>        
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Admins</span>
                </div>
                </li>
            </ol>
        </nav>
            ...
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                ...
                <tr v-for="admin in admins" :key="admin.id" class="hover:bg-gray-50">
                    ...
                    <div class="text-sm">
                        ...
                        <div class="text-gray-400">{{ admin.email }}</div>
                    </div>
                    </th>
...
const searchForm = () => {
    search.get(route('admin.admins.index'))
}
const submitForm = () => {
...
const deleteDepartment = (id,name) =>{
    ...
    alerta.fire({
        ...
        if(result.isConfirmed){
            form.delete(route('admin.admins.destroy', id))
        }
    });
}
</script>
